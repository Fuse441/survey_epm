  ...
  return (
    <div className="w-[500px]">
     ...
     <Input
      isRequired
      errorMessage={
        <div className="text-start w-full">ต้องเป็นตัวอักษร (a-z) และตัวเลข (0-9) เท่านั้น ห้ามมีอักขระพิเศษและช่องว่าง</div>
      }
    ...
    />
     <Input
      isRequired
      errorMessage={
        <div className="text-start w-full">ต้องมีตัวอักษร (a-z), ตัวเลข (0-9), และอักขระพิเศษอย่างน้อยหนึ่งตัว</div>
      }
    ...
    />
      <Input
        isRequired
        errorMessage={
          <div className="text-start w-full">ต้องมีตัวอักษร + @ + domain + .com หรือ .net เป็นต้น
ห้ามมีอักขระพิเศษที่ไม่ถูกต้อง</div>
        }
