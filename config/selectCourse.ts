  ...
  "IT Services (ฝ่ายบริการเทคโนโลยีสารสนเทศ)": [
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อเพิ่มทักษะในการให้บริการด้าน IT Support อย่างมืออาชีพ ลด Downtime และเพิ่มประสิทธิภาพการให้บริการ",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อป้องกันข้อมูลสำคัญขององค์กรจากการโจมตีทางไซเบอร์ และลดความเสี่ยงจากการสูญหายของข้อมูล",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อพัฒนาการบริหารจัดการระบบไอทีให้มีประสิทธิภาพ ลดข้อผิดพลาด และปรับปรุงกระบวนการทำงาน",
    },
  ],
  "Solutions Development (ฝ่ายพัฒนาดิจิทัลโซลูชั่นส์)": [
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อเรียนรู้การพัฒนาเว็บแอปพลิเคชันแบบครบวงจร ด้วยเครื่องมือที่ทันสมัย ช่วยให้สามารถสร้างแอปที่มีประสิทธิภาพและตอบสนองความต้องการของผู้ใช้ได้ดียิ่งขึ้น",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "ช่วยให้การพัฒนาและการปล่อยแอปพลิเคชันเร็วขึ้นและมีความเสถียร โดยใช้เครื่องมืออย่าง Docker และ Kubernetes ในการบริหารจัดการแอปให้มีประสิทธิภาพและลดความผิดพลาด",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อพัฒนาทักษะการใช้ AI และ Machine Learning ในการสร้างโมเดลที่สามารถเรียนรู้และปรับใช้กับข้อมูล ช่วยเพิ่มประสิทธิภาพในการตัดสินใจและการพัฒนาซอฟต์แวร์",
    },
  ],
  "Accounting & Finance (งานบัญชีและการเงิน)": [
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อเรียนรู้การใช้ Excel วิเคราะห์ข้อมูลทางการเงินและจัดทำงบการเงินให้ถูกต้องและแม่นยำ ช่วยเพิ่มประสิทธิภาพในการจัดการข้อมูลการเงิน",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อเข้าใจเกี่ยวกับกฎหมายและมาตรฐานบัญชีที่สำคัญ และสามารถบริหารจัดการภาษีอย่างถูกต้อง ป้องกันข้อผิดพลาดทางกฎหมาย",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อใช้ข้อมูลทางการเงินในการคาดการณ์แนวโน้มและบริหารความเสี่ยงทางการเงิน ช่วยให้สามารถตัดสินใจทางการเงินได้ดีขึ้น",
    },
  ],
  "Human Resource (ฝ่ายทรัพยากรบุคคล)": [
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อเรียนรู้การใช้เทคโนโลยีในการบริหารงานบุคคล ช่วยเพิ่มประสิทธิภาพในการจัดการข้อมูลพนักงานและปรับองค์กรให้ทันสมัยในยุคดิจิทัล",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อเรียนรู้การคำนวณและจัดการเงินเดือนและสวัสดิการพนักงานให้ถูกต้องและรวดเร็ว ช่วยลดความผิดพลาดในการคำนวณและเพิ่มความพึงพอใจให้กับพนักงาน",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อใช้ข้อมูลในการวิเคราะห์และจัดการทรัพยากรบุคคลให้มีประสิทธิภาพ ช่วยพัฒนากลยุทธ์การบริหารทรัพยากรบุคคลที่มีข้อมูลรองรับ",
    },
  ],
  "Administration (ฝ่ายธุรการ)": [
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เรียนรู้การบริหารงานธุรการในยุคดิจิทัล จัดการเอกสารอิเล็กทรอนิกส์ให้เป็นระบบ ลดข้อผิดพลาดและเพิ่มประสิทธิภาพการทำงาน",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "ใช้ระบบอัตโนมัติช่วยจัดการเอกสาร ลดภาระงานซ้ำซ้อน และเพิ่มความรวดเร็วในการดำเนินงาน",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เรียนรู้การใช้เครื่องมือบริหารโครงการ ติดตามงาน และสื่อสารกับทีมได้อย่างมีประสิทธิภาพ",
    },
  ],
  "Procurement (ฝ่ายจัดซื้อ)": [
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เข้าใจหลักการจัดซื้อและซัพพลายเชน ช่วยวิเคราะห์ต้นทุนและเลือกซัพพลายเออร์ได้อย่างเหมาะสม",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "ใช้เทคโนโลยีบริหารจัดซื้อแบบดิจิทัล พร้อมวิเคราะห์แนวโน้มซัพพลายเชนด้วย AI และ Power BI",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เรียนรู้แนวปฏิบัติด้าน ESG ในการจัดซื้อ เพื่อลดความเสี่ยงและส่งเสริมความยั่งยืนขององค์กร",
    },
  ],
  "Project Management (ฝ่ายบริหารงานโครงการ)": [
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อให้สามารถบริหารโครงการได้อย่างมีประสิทธิภาพ ลดความล่าช้าและข้อผิดพลาดในการดำเนินงาน พร้อมรับมือกับความเปลี่ยนแปลงของโครงการ",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อให้สามารถบริหารต้นทุนโครงการได้อย่างมีประสิทธิภาพ ลดการใช้ทรัพยากรเกินความจำเป็น และเพิ่มผลตอบแทนจากการลงทุน",
    },
  ],
  "Sales (ฝ่ายขาย)": [
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อช่วยให้ฝ่ายขายสามารถบริหารความสัมพันธ์กับลูกค้าได้ดีขึ้น เพิ่มโอกาสในการปิดการขาย และสร้างความพึงพอใจให้กับลูกค้า",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อเพิ่มทักษะการขายในตลาดองค์กร พัฒนาการนำเสนอและปิดการขายที่สามารถตอบโจทย์ลูกค้าได้อย่างตรงจุด",
    },
    {
      ...
      noti: "*หากท่านต้องการอบรม ณ สถานประกอบการ กรุณาติดต่อเจ้าหน้าที่ของสถาบันพัฒนาฝีมือแรงงาน",
      reason:
        "เพื่อให้ฝ่ายขายสามารถใช้ข้อมูลมาวิเคราะห์และคาดการณ์แนวโน้มตลาด เพิ่มโอกาสปิดการขายและพัฒนาแผนการขายอย่างแม่นยำ",
    },
  ],
};
